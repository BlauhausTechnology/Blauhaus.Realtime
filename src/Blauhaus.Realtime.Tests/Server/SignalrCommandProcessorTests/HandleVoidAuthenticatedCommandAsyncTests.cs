...
{
    [TestFixture]
    public class HandleVoidAuthenticatedCommandAsyncTests : BaseSignalrCommandProcessorTest
    {
        protected VoidAuthenticatedCommandHandlerMockBuilder<TestCommand, IAuthenticatedUser> MockCommandHandler => Mocks.AddMockVoidAuthenticatedCommandHandler<TestCommand, IAuthenticatedUser>().Invoke();
        ...
        public async Task IF_handler_succeeds_SHOULD_return_sucess()
        {
            ...
            //Act
            var result = await Sut.HandleVoidAuthenticatedCommandAsync(Command, Properties, Connection);
        ...
        {
            return await Sut.HandleVoidAuthenticatedCommandAsync(command, properties, clientConnection);
        }
